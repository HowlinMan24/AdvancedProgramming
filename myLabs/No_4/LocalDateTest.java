...
public class LocalDateTest {
    ...
    static LocalDate plusPeriod() {
         ...
         */
        LocalDate period=LocalDate.of(1,2,3);
        return ld.plusYears(period.getYear()).plusMonths(period.getMonthValue()).plusDays(period.getDayOfMonth());
    }

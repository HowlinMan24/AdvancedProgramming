...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeParse() {
         ...
         */
        return LocalDateTime.parse("2015-06-20T23:07:30", DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss"));
    }
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        return LocalDateTime.of(2015, 6, 18, 23, 0, 0);
    }
    ...
    static String localDateTimeFormat() {
         ...
         */
        return ldt.format(DateTimeFormatter.ofPattern("yyyy_MM_dd_HH:mm:ss"));
    }
    ...
    static String toLocalDateAndTime() {
        ...
        LocalTime localTime = LocalTime.of(ldt.getHour(), ldt.getMinute(), ldt.getSecond());
    ...
    static String toLocalDateTime() {
         ...
         */
        LocalDateTime localDateTime1 = LocalDate.EPOCH.atTime(lt);
        LocalDateTime localDateTime2 = LocalTime.MAX.atDate(ld);
